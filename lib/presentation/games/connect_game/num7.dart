...
class Number7 extends StatefulWidget {
  ...
  final Map content = _gamesObjects.connect['7'];
                ...
                onAcceptWithDetails: (data) {
                  setState(() {
                    if(len>=2){
                      ...
                      targetHeightRatio = 8.0;
                      targetWidthRatio = 13.0;
                      dragWidthRatio=6.0;
                      dragHeightRatio = 10.5;
                      len = 3;

                      _prefs.setGameState(gameName: '8', state: false);
                      Future.delayed(
            ...
            Positioned(
              ...
              child: Draggable<String>(
                  onDragUpdate: (details) {
                    ...
                    setState(() {
                      if (dy >= h / 1.5 && dx <= w / 1.8) {
                        len = 2;
                        dragWidthRatio = 2.3;
                        dragHeightRatio = 1.55;
                      } else {
                        setState(() {
                          dragWidthRatio =
